...
_INSTALLER_RECIPE_PATHS = (
    ...
    "distribution/windows/lifecycle/ticketbox_lifecycle/policy/health_attestation.py",
    ...
    "distribution/windows/lifecycle/ticketbox_lifecycle/runtime/windows_installation_health.py",
