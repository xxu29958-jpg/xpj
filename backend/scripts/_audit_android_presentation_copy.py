...
ALLOWLIST: dict[str, str] = {
    ...
    "android/app/src/main/java/com/ticketbox/viewmodel/ExpenseEditViewModel.kt :: 未命名": "static fallback-default item name value",
    "android/app/src/main/java/com/ticketbox/viewmodel/ExpenseEditViewModel.kt :: 未命名成员": "static fallback-default split member name value",
