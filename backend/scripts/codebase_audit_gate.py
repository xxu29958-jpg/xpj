...
STRICT_EQUALITY_BASELINE.update({
    "backend_pytest_count": 2334,
    "mutate_token_carriers": 74,
    "mutate_token_exempted": 122,
    "mutate_token_reason_create_row": 32,
})  # +2 ADR-0053 web merchant catalog hide/delete OCC carriers; +1 create-row exemption for POST /web/merchants/catalog/create; +3 collected pytest delta for viewer write-guard parameter cases; +1 ADR-0054 merchant catalog key-changing rename live-config blocker test.
