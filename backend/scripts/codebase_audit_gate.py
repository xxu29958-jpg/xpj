...
CODEBASE_DEBT_LIMITS: DebtCounts = {
    ...
    "files_over_500": 15,
    "long_functions": 6,  # 2026-07-09: bill-split invitation create flow split.
...
STRICT_EQUALITY_BASELINE: DebtCounts = {
    ...
    "backend_pytest_count": 2403,  # Current collected pytest count. Ratchet provenance lives in PR history.
}
