...
CODEBASE_DEBT_LIMITS: DebtCounts = {
    ...
    # silently re-creep.
    "unreferenced_modules": 205,  # +2 ADR-0043 tag_management_service + tag_undo_service (covered via /api/tags route tests, not direct import); +2 slice C web_tags + owner_console._tag_cleanup (HTTP-tested, not direct import); −15 PG-only slice 2 (retired _migrations/ + _validate/ submodules); −1 slice 5 (retired cut-over modules); −1 ratchet tighten on the gate's own improved-INFO (2026-06-11)
    "import_cycles": 0,
