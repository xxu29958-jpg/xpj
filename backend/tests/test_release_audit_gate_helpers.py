...
def test_pr_delta_accepts_adr_0049_exact_down_ratchet_exception(monkeypatch) -> None:
    # The single in-flight grandfather now points at the desktop switch-prepare
    # exemption (218-E). Older up-hops are dead history.
...
def test_pr_delta_adr_0049_exception_does_not_allow_future_growth(monkeypatch) -> None:
    ...
    for base_count, current_count in ((116, 119), (119, 120), (120, 121), (121, 122), (122, 123), (123, 124), (123, 125), (123, 126), (123, 128), (126, 127), (128, 129), (128, 130)):
        baseline = dict(mod.STRICT_EQUALITY_BASELINE)
