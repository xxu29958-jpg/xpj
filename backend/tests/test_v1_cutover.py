...
def test_binary_rejected_when_db_locked_to_v1() -> None:
    """If a future v1.0 cut-over has been recorded, this v0.9.0a1 binary
    must refuse to mount the DB."""
    with SessionLocal() as db:
...
def test_v1_migration_handler_refuses_pre_v1_binary() -> None:
