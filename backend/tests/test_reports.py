...
from tests._reports_overview_contracts import (
    assert_reports_overview_category_comparison,
    assert_reports_overview_period_totals,
    assert_reports_overview_trend_and_ranking,
    fetch_reports_overview_contract,
    seed_reports_overview_contract,
)
...
def test_reports_overview_trends_rankings_and_category_comparison(
    ...
    *,
    ...
    assert_reports_overview_period_totals(payload)
    assert_reports_overview_trend_and_ranking(payload)
    assert_reports_overview_category_comparison(payload)
