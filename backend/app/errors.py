...
ERROR_MESSAGES = {
    ...
    "manual_currency_context_required": "这份草稿缺少币种依据，请先核对输入与已有流水。",
    "manual_create_original_requires_review": "无法核实这笔提交最初的保存结果。原输入已保留，请核对已有账单后再处理。",
    ...
    "image_replenishment_mismatch": "所选文件与这笔账单的原件不一致，请选择同一原件；账单和本次输入会保留。",
    ...
    "recurring_merchant_too_long": "固定支出名称过长，请缩短后再试。",
    ...
    "merchant_alias_conflict": "商家别名已存在。",
