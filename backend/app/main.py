...
from app.routes import auth, bootstrap, budgets, duplicates, expenses, insights, invitations, ledgers, maintenance, merchants, recurring, rules, settings, stats, uploads
