...
from app.routes import auth, bootstrap, budgets, duplicates, expenses, insights, invitations, ledgers, maintenance, merchants, recurring, reports, rules, settings, stats, uploads
