...
from app.tag_text import clean_tag_name, parse_tags, tag_key, validate_tags_fit_storage


def _validated_tag_names(value: str | None) -> list[str]:
    try:
        validate_tags_fit_storage(value)
...
def set_expense_tags(db: Session, expense: Expense, value: str | None) -> None:
    ...
    names = _validated_tag_names(value)
