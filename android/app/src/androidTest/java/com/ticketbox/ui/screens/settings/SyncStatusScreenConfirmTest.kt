...
class SyncStatusScreenConfirmTest {
    ...
    fun offsetConflictOpensTheCurrentFactWithoutOfferingAnOverwrite() {
        ...
        setScreenContent(conflicts = listOf(original), actions = SyncStatusActions(onOpenRateSubmission = {}, onOpenIncomeSubmission = {}, onOpenRuleSubmission = {}, onOpenGoalEdit = {}, onOpenGoalCreation = {}, onOpenRecurring = {}, onOpenBudget = {},
    ...
    fun unverifiableOffsetKeepsReviewAndDropWithoutRetry() {
        ...
        val original = outboxRow(PendingMutationStatus.Failed, "offset_create_requires_review")
            .copy(type = PendingMutationType.CreateExpenseOffset)
        setScreenContent(failed = listOf(original), actions = SyncStatusActions(onOpenRateSubmission = {}, onOpenIncomeSubmission = {}, onOpenRuleSubmission = {}, onOpenGoalEdit = {}, onOpenGoalCreation = {}, onOpenRecurring = {}, onOpenBudget = {},
    ...
    fun conflictDropAsksForConfirmationBeforeFiring() {
        ...
        setScreenContent(
            ...
            actions = SyncStatusActions(onOpenRateSubmission = {}, onOpenIncomeSubmission = {}, onOpenRuleSubmission = {}, onOpenGoalEdit = {}, onOpenGoalCreation = {}, onOpenRecurring = {}, onOpenBudget = {},
        onOpenExpense = {},
                onKeepMine = {},
    ...
    fun switchingBindingRetiresAnOpenDropConfirmationBeforeTheNextSnapshot() {
        ...
        composeRule.setContent { TicketboxTheme(skin = AppSkin.Default) {
            SyncStatusScreenContent(state.value, SyncStatusActions(onOpenRateSubmission = {}, onOpenIncomeSubmission = {}, onOpenRuleSubmission = {}, onOpenGoalEdit = {}, onOpenGoalCreation = {}, onOpenRecurring = {}, onOpenBudget = {}, onOpenExpense = {}, onKeepMine = {},
    ...
    fun unsupportedIncomeKeepsItsExplanationAndDropWithoutRetry() {
        ...
        setScreenContent(failed = listOf(row), incomeSubmissions = mapOf(row.id to PendingIncomePlanSubmission(row, null)),
            actions = SyncStatusActions(onOpenRateSubmission = {}, onOpenIncomeSubmission = {}, onOpenRuleSubmission = {}, onOpenGoalEdit = {}, onOpenGoalCreation = {}, onOpenRecurring = {}, onOpenBudget = {}, onOpenExpense = {}, onKeepMine = {}, onDropMine = {}, onRetry = { error("Unsupported retry") },
