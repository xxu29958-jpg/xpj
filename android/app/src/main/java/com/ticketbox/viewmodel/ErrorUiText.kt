...
private val errorCodeStringResByCode = mapOf(
    ...
    "recurring_ledger_conflict" to R.string.recurring_error_ledger,
    "recurring_currency_conflict" to R.string.recurring_form_error_currency,
    "recurring_command_owner_unavailable" to R.string.recurring_error_command_owner,
