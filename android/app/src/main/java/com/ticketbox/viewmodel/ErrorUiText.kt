...
private val errorCodeStringResByCode = mapOf(
    ...
    "image_replenishment_mismatch" to R.string.original_digest_mismatch,
    "original_review_conflict" to R.string.original_review_conflict,
    "original_already_verified" to R.string.original_review_conflict,
    "original_identity_unverified" to R.string.original_unverified,
    "attachment_cleanup_changed" to R.string.original_review_conflict,
    "attachment_cleanup_invalid" to R.string.original_cleanup_invalid,
    "original_source_unavailable" to R.string.original_source_unavailable,
    "original_writer_required" to R.string.original_writer_required,
    ...
    "recurring_merchant_too_long" to R.string.error_recurring_merchant_too_long,
    "recurring_observed_merchant_immutable" to R.string.error_recurring_observed_merchant_immutable,
