...
data class Expense(
    ...
    val homeCurrency: CurrencyCode = FxContract.LegacyHomeCurrencyFallback,
    val originalCurrency: CurrencyCode = FxContract.LegacyHomeCurrencyFallback,
    ...
    val originalCurrencyCode: CurrencyCode = FxContract.LegacyHomeCurrencyFallback,
