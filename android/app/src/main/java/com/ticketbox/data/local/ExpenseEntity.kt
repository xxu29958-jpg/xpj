...
data class ExpenseEntity(
    ...
    val homeCurrencyCode: String = FxContract.LegacyHomeCurrencyFallback.storageKey,
    val originalCurrencyCode: String = FxContract.LegacyHomeCurrencyFallback.storageKey,
