...
/**
 * 通知闭环 PR-2：[draftNotificationContentSpec] / [recurringNotificationContentSpec]
 * 内容规格（channel / 标题 format-arg / 锁屏 public 脱敏 / 去核对 action）的纯 JVM 测试。
 * 决策矩阵在 [TicketboxNotifierDecisionTest]；本文件按 TooManyFunctions 门拆出规格面。
 */
class TicketboxNotifierContentSpecTest {
