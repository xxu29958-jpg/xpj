...
class MascotPaletteTest {
    ...
    fun paletteMapsEachSlotToItsBriefTokenAcrossAllSkins() {
        AppSkin.entries.forEach { skin ->
            ...
            assertEquals(visuals.surfaceSunken, palette.bodyFill, "bodyFill@$skin")
            ...
            assertEquals(states.danger.bg, palette.blushFill, "blushFill@$skin")
            assertEquals(visuals.primary, palette.clipAccent, "clipAccent@$skin")
