...
class ExpenseItemDtoContractTest {
    ...
    fun expenseItemsParsesCurrentServerShapeAndSerializesReplace() {
        ...
        assertEquals(
            """{"expected_row_version":1,"items":[{"name":"拿铁","kind":"product","quantity_text":"1杯","unit_price_cents":500,"amount_cents":500,"category":"餐饮","raw_text":"拿铁 1杯 5.00","confidence":0.92}]}""",
            requestJson,
        )
    }
}
