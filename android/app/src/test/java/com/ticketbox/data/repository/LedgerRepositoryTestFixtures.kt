...
internal class StubApi(
    ...
    override suspend fun listBillSplitInbox(): com.ticketbox.data.remote.dto.BillSplitInboxListResponseDto = ledgerUnsupported()
    ...
    override suspend fun archiveIncomePlan(publicId: String): com.ticketbox.data.remote.dto.IncomePlanDto = ledgerUnsupported()
    override suspend fun restoreIncomePlan(publicId: String): com.ticketbox.data.remote.dto.IncomePlanDto = ledgerUnsupported()
