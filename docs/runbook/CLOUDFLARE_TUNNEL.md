...
ingress:
  ...
  - hostname: api.your-domain.com
    path: ^/(web(?:/|$)|static/(?:web|shared)(?:/|$)|u/|api/(?:health$|auth/(?:check|pair)$|system/runtime-compatibility$|expenses(?:/|$)|reports(?:/|$)|goals(?:/|$)|dashboard(?:/|$)|budgets(?:/|$)|recurring(?:/|$)|merchants(?:/|$)|rules(?:/|$)|duplicates(?:/|$)|imports(?:/|$)|stats(?:/|$)|me(?:/|$)|exchange-rates(?:/|$)|settings(?:/|$)|ledgers(?:/|$)|invitations(?:/|$)))
