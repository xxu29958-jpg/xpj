...
- 简体中文语言文件：仓库内置 `backend/packaging/languages/ChineseSimplified.isl`，来源 JRSoftware `https://jrsoftware.org/files/istrans/` 指向的 `https://raw.githubusercontent.com/jrsoftware/issrc/refs/heads/main/Files/Languages/ChineseSimplified.isl`；Git blob SHA `0fced9759dd20e250101768985af511153133cdc`，文件 sha256 `6753be2c5e2740d859900fd902824db2ec568da5c5b52486524c9762d778b0b0`，适配 Inno `6.5.0+`。更新语言文件时必须同步本条 hash。
