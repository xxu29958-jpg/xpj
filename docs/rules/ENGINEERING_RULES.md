...
详见 [CODE_QUALITY_STANDARDS.md](CODE_QUALITY_STANDARDS.md)：ruff 规则集、line-length、McCabe 复杂度、Kotlin 阈值（评审基准——detekt 从未接线，机器守护待拍板）、PR 议题纪律、Conventional Commits、main 合并纪律。
