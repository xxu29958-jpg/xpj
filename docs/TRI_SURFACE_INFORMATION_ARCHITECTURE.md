...
| 家庭成员 placeholder | 家庭成员邀请在 v0.5 才会开启 |
...
2. **本月已入账** — 来自 `lifestyleStats` / `monthlyStats`，无数据显示
   “这个月还没有已确认账单”。
...
```
设备管理 · 上传链接 · 账本管理 · 备份 · 诊断 · Windows 任务状态
```
