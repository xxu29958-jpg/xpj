...
|---|---|---|
| First use and household entry | Invitation handoff, real local Web identity and ended-browser history are integrated. Desktop first-use explanation and expired-code continuation still need current consumer closure | Owner/member/viewer can enter the intended household, understand where data lives and recover from an expired/failed connection without losing entered intent or gaining another identity |
