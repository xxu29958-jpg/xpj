...
当前施工：原生 CSV 续办、统一账务日期、原件完整性及 [#425 可携带出口](https://github.com/xxu29958-jpg/xpj/pull/425)已合入主线。按用户最新排序，依次收口 [#426 往来时间线](https://github.com/xxu29958-jpg/xpj/pull/426)、[#427 拆账约定](https://github.com/xxu29958-jpg/xpj/pull/427)，具体合并与主线资格记录留在对应 PR 和直接合同。完整五域、Backstage、保留条件和下列终点继续有效，不构成这几张 PR 的额外合并前置条件。
...
**当前施工先手：**#425 已合并，优先收口现有 #426～#427，不新增叠层、不扩大重审；保留后续已完成代码，待现有候选合并后按完整目标继续。已有读写、原始草稿、回执、历史和恢复能力不能因改造缩水；不能退回零散页面队列，也不能由分析 CSV 独自冒充完整数据出口。
