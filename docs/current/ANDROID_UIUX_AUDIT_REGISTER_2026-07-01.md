...
| S6 Settings governance | In progress | `b61dbedd` plus Settings root, My Devices, Family Members, Connection, Join Family, and Category Rules secondary slices | Root governance and secondary state parity. |
