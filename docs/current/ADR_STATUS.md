...
- 组合审查日期: 2026-07-11
- Code baseline: `0f1092e625b376d0fa8d4abc214cdc53de93a96d` (`main`)
- Baseline scope: `main` 的产品/运行时代码证据，加安装器独立工作树中的 0062–0064 设计证据；
  本分支不吸收安装器运行时代码。
- Governance: [[0065]]
...
| --- | --- | --- | --- | --- | --- |
| [0001](../DECISIONS/0001-money-uses-cents.md) | accepted | implemented | unverified | 权威金额使用有界整数 minor-unit 与显式币种；0061/0073 定义 binding、舍入、更正和投影 | — |
...
| [0016](../DECISIONS/0016-performance-and-stability-baseline.md) | superseded | implemented | stale | 历史 SQLite/无后台框架性能基线；当前 PostgreSQL 容量、背压、任务事实与 executor adapter 由 0072 裁决 | — |
...
| [0022](../DECISIONS/0022-family-ledger-permission-model.md) | superseded | implemented | stale | 历史家庭权限矩阵；当前 Account/Ledger/Device/Token/UploadLink/Web/恢复权限由 0068 裁决 | — |
| [0023](../DECISIONS/0023-chart-library-policy.md) | accepted | implemented | unverified | 图表仅消费结构化只读投影；依赖须可审计、可回退、无 CDN，失败不得改变账本 | — |
| [0024](../DECISIONS/0024-tri-surface-ui-ux-unification.md) | accepted | partial | unverified | member/owner/maintainer/auditor 跨端同语言不同布局；覆盖加载、失败、副作用、a11y 与极值输入 | — |
...
| [0027](../DECISIONS/0027-backend-authoritative-fx.md) | accepted | implemented | unverified | 后端以 Decimal 和发生日裁决并冻结原币/home snapshot；0061/0073 补 currency binding 与更正事实 | — |
...
| [0038](../DECISIONS/0038-v1.3-multi-surface-sync.md) | accepted | nonconformant | failed | PostgreSQL 是账本真源，Room confirmed 是投影，outbox 是设备未提交 intent；退出、quarantine 与 mixed-version 由 0069 裁决 | — |
...
| [0042](../DECISIONS/0042-offline-availability-and-request-idempotency.md) | accepted | nonconformant | failed | outbox intent key、fingerprint、committed-but-unseen 与安全 replay；0057/0069 接管 stable result 和 binding exit | amends 0038 |
...
| [0045](../DECISIONS/0045-csrf-signing-key.md) | accepted | partial | unverified | 持久随机 CSRF/session key 与 placeholder fail-closed；restore/clone/identity 生命周期由 0059/0068 收紧 | — |
| [0046](../DECISIONS/0046-android-recurring-reminder-detection-source.md) | accepted | partial | unverified | WorkManager 仅作持久 best-effort 检测器；投递 outcome、single-flight 与非 exactly-once 语义由 0058 收紧 | — |
| [0047](../DECISIONS/0047-bundled-installer-windows-services.md) | accepted | partial | stale | Windows SCM/虚拟账户/ProgramData/loopback 仅是宿主 adapter；生命周期、bootstrap、provenance 分别由 0062–0064 接管 | depends-on 0041; depends-on 0028; depends-on 0045 |
| [0048](../DECISIONS/0048-rive-mascot-animation.md) | rejected | not-started | stale | Rive 方案已拒绝且无代码消费者；仅保留历史，不得复活为实现债 | — |
| [0049](../DECISIONS/0049-debt-domain-contract.md) | accepted | partial | unverified | Debt obligation 与 repayment/correction/forgiveness facts；身份依赖 0068，纯 fold/rebuild 由 0060/0073 收紧 | depends-on 0001; depends-on 0068; depends-on 0027; depends-on 0029; depends-on 0038; depends-on 0041; depends-on 0042 |
...
| [0061](../DECISIONS/0061-home-currency-minor-unit-semantics.md) | accepted | nonconformant | failed | home-currency identity、minor-unit exponent、rounding、跨端 capability 与 FX snapshot | amends 0001; amends 0027 |
| [0062](../DECISIONS/0062-windows-installer-lifecycle-transaction.md) | accepted | nonconformant | failed | Windows 安装/升级/修复/卸载生命周期；main 基线未实现，installer overlay 仍有未持久化复制边界和非原子恢复标记 | amends 0047; depends-on 0041; informational 0006 |
| [0063](../DECISIONS/0063-recoverable-owner-bootstrap-ceremony.md) | accepted | partial | failed | main 未实现；overlay 已有 HMAC/DB 锁/listener recovery/handoff，但精确恢复、并发撤销、凭证解耦和 handoff 父目录 ACL 审查失败 | amends 0047; depends-on 0028; depends-on 0045 |
